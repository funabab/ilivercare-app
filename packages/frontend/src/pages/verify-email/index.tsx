...
const VerifyEmailPage: React.FC<Props> = () => {
  const [sendEmail, isLoading] = useSendEmailVerification(firebaseAuth)
      ...
      <Box>
        ...
        >
          ...
          <rect
            ...
            fill="#d0cde1"
          />
          <circle cx="292.74433" cy="16.4075" r="5.18132" fill="#00bfa6" />
          <path
          ...
          <path
            ...
            fill="#3f3d56"
          />
          <circle cx="437.85129" cy="559.70682" r="18" fill="#00bfa6" />
          <path
        ...
        onClick={() =>
          sendEmail()
            .then(() => {
              toast({
                title: 'Success',
                description: `Verification mail sent to ${
